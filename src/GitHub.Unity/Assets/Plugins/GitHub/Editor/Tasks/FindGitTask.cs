...
namespace GitHub.Unity
{
    class FindGitTask : ProcessTask
    {
        ...
        protected override string ProcessName { get { return Utility.IsWindows ? "dir" : "which"; } }
        protected override string ProcessArguments { get { return Utility.IsWindows ? "/s git.exe" : "git"; } }
