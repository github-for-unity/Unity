...
{
    [TestFixture]
    public class MacFileSystemWatchTests
    {
        ...
        {
            TestFileSystemWatcher testWatcher = null;
        ...
        {
            TestFileSystemWatcher parentWatch = null;
            TestFileSystemWatcher child1Watch = null;
            TestFileSystemWatcher child2Watch = null;
