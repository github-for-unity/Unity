...
namespace GitHub.Unity
{
    class GitConfigListTask : GitTask
    {
        ...
        public GitConfigListTask(IEnvironment environment, IProcessManager processManager, ITaskResultDispatcher resultDispatcher,
                                GitConfigSource configSource, Action<string> onSuccess, Action onFailure)
