...
Run-Command -Fatal { & "$rootDirectory\src\git-for-unity\create-unity-packages\run.ps1" -PathToPackage "$rootDirectory\packages\com.github.ui" -OutputFolder "$rootDirectory" -PackageName com.github.ui -Version "$uiVersion" -Ignores "$rootDirectory\packages\com.github.ui\.npmignore" }
Run-Command -Fatal { & "$rootDirectory\src\git-for-unity\create-unity-packages\run.ps1" -PathToPackage "$rootDirectory\packages\com.unity.git.api" -OutputFolder "$rootDirectory" -PackageName com.unity.git.api -Version "$apiVersion" -Ignores "$rootDirectory\packages\com.unity.git.api\.npmignore" }
